...
TOKEN = "EAALlnc8E2GEBALekGRS4wwIK0aOnueBZCFc3J6ET7paxNfTcSqtImMB6kMg1LbBaRQ2WAidhIZCABbkSjtfXXD0CNoxuh91Tka81oTYMXZB7inPGEahnDlIHBlIUrwwD0wLZAXCc1GL5NoqwyGLXrC6H4BYOoujsnXEGGzOnXAZDZD"
        ...
        for entry in data["entry"]:
            for messaging_event in entry["messaging"]:
                if messaging_event.get('message'):
                    # Facebook Messenger ID per utente in modo da sapere dove mandare indietro la risposta
...
# Utilizzo PyMessenger per inviare la risposta all'utente
def invia_messaggio(recipient_id, response):
    # invio all'utente il messaggio di testo fornito dal parametro di risposta
